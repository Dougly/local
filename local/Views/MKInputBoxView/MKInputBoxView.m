...
{
    CGFloat actualBoxHeight = 135.0f;
...
- (void)setupView
{
    ...
    UILabel *titleLabel     = [[UILabel alloc] initWithFrame:
                               CGRectMake(padding, padding + 8, width, 20)];
    ...
    if (IS_IPHONE_5 || IS_IPHONE_4) {
        ...
        titleLabel.font         = [UIFont fontWithName:@"HelveticaNeue-Light" size:17.0];
    }
    ...
    UILabel *messageLabel   = [[UILabel alloc]initWithFrame:
                               CGRectMake(padding, padding + titleLabel.frame.size.height + 5, width, 8)];
    messageLabel.numberOfLines  = 2;
    messageLabel.font       = [UIFont fontWithName:@"HelveticaNeue-Light" size:13.0];
