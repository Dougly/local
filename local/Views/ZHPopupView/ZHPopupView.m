...
#define kZHPopupViewContainerDefaultHeight 100.0f
...
- (void)layoutSubviews {
    ...
    frame.origin.y = previousYPos + 16.0f;
...
- (void)configureButtonWithTitles:(NSArray *)titles confirmTitleColor:(UIColor *)confirmTitleColor otherTitleColor:(UIColor *)otherTitleColor {
    ...
    confirmTitleColor = (nil == confirmTitleColor) ? kTotsAmourBrandColorHEX : confirmTitleColor;
...
- (UIView *)container {
    if (nil == _container) {
        ...
        int margin = kZHPopupViewContainerLeftRightInterval;
        ...
        CGFloat width = ((nil != self.parentView) ? self.parentView.bounds.size.width : kZHPopupView_ScreenWidth) - 2 * margin;
