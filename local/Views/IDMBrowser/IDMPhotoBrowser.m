...
- (void)viewDidLoad {
    ...
    if(!_doneButtonImage) {
        ...
        [_doneButton.titleLabel setFont:[UIFont fontWithName:@"HelveticaNeue-Light" size:16]];
        [_doneButton setBackgroundColor:kTotsAmourBrandColorHEX];
...
- (CGRect)frameForDoneButtonAtOrientation:(UIInterfaceOrientation)orientation {
    ...
    return CGRectMake(screenWidth - 75, 30, 65, 30);
}
